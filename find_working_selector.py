...
if core_div:
    ...
    if price_to_pay:
        ...
        if aria:
            ...
            print(f"  Selector: #corePriceDisplay_desktop_feature_div span.priceToPay span[aria-hidden='true']")
...
if first_match:
    ...
    if text:
        ...
        for i, match in enumerate(all_matches[:5]):
            ...
            print(f"    [{i}] '{text}' (parent classes: {parent_class}) {'← priceToPay' if has_price_to_pay else ''}")
