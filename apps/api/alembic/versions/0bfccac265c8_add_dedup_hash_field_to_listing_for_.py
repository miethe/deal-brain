...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        op.f("ix_valuation_ruleset_active_priority"),
        "valuation_ruleset",
        ["is_active", "priority"],
        unique=False,
    )
    op.create_index(
        op.f("idx_ruleset_created_by"), "valuation_ruleset", ["created_by"], unique=False
    )
    ...
    op.create_index(
        op.f("idx_rule_v2_eval_order"),
        "valuation_rule_v2",
        ["group_id", "evaluation_order"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_valuation_rule_group_is_active"),
        "valuation_rule_group",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rule_group_entity_key"),
        "valuation_rule_group",
        [sa.literal_column("(metadata_json ->> 'entity_key'::text)")],
        unique=False,
    )
    op.create_index(
        op.f("idx_rule_group_ruleset"), "valuation_rule_group", ["ruleset_id"], unique=False
    )
    op.create_index(
        op.f("idx_rule_group_category"), "valuation_rule_group", ["category"], unique=False
    )
    op.alter_column(
        "valuation_rule_group",
        "metadata_json",
    ...
    op.create_index(
        op.f("idx_condition_rule"), "valuation_rule_condition", ["rule_id"], unique=False
    )
    op.create_index(
        op.f("idx_condition_parent"),
        "valuation_rule_condition",
        ["parent_condition_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_listing_vendor_marketplace"),
        "listing",
        ["vendor_item_id", "marketplace"],
        unique=False,
    )
    op.create_index(
        op.f("ix_listing_secondary_storage_profile_id"),
        "listing",
    ...
    op.create_index(
        op.f("ix_listing_primary_storage_profile_id"),
        "listing",
    ...
    op.create_index(
        op.f("idx_listing_dollar_per_cpu_single_adj"),
        "listing",
        ["dollar_per_cpu_mark_single_adjusted"],
        unique=False,
    )
    op.create_index(
        op.f("idx_listing_dollar_per_cpu_single"),
        "listing",
        ["dollar_per_cpu_mark_single"],
        unique=False,
    )
    op.create_index(
        op.f("idx_listing_dollar_per_cpu_multi_adj"),
        "listing",
        ["dollar_per_cpu_mark_multi_adjusted"],
        unique=False,
    )
    op.create_index(
        op.f("idx_listing_dollar_per_cpu_multi"),
        "listing",
    ...
    op.create_index(
        op.f("ix_custom_field_audit_field"),
