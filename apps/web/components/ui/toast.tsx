  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "destructive" && "destructive bg-destructive text-destructive-foreground border-destructive",
        variant === "success" && "bg-[hsl(var(--success))] text-[hsl(var(--success-foreground))] border-[hsl(var(--success))]",
        className
      )}
      {...props}
    />
