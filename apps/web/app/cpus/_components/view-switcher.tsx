...
/**
 * CPU View Switcher Component
 *
 * Toggle button group for switching between catalog view modes:
 * - Grid: Card-based responsive grid layout
 * - List: Compact list view with inline details
 * - Compare: Master-detail view for side-by-side comparison
 *
 * State is persisted in cpu-catalog-store.
 */
